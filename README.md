...
<div class="paragraph">
<p>If you want to view the versions of files a tag is pointing to, you can do a git checkout, though this puts your repository in “detached HEAD” state, which has some ill side effects:</p>
</div>
<div class="listingblock">
<div class="content">
...
<div id="nav"><a href="/book/en/v2/Git-Basics-Working-with-Remotes">prev</a> | <a href="/book/en/v2/Git-Basics-Git-Aliases">next</a></div></div>
</div>
...
<script src="/assets/site-2ef7455924ddd0329ee146d8719bb7b5.js"></script>
